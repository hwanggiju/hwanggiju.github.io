...
### 7. 동작 영상 YouTube 링크
  ...
  [시연영상 클릭](https://youtu.be/TopgEwy2sZo)

### 8. 프로젝트 후기

   프로젝트를 진행하는 동안 팀원들과의 갈등과 개발과정의 많은 어려움이 있었는데, 프로젝트를 마무리 짓고 최종 발표를 성공적으로 끝마쳤을 땐 이전에 고생했던 일들을 보상받는 기분이었다.
  
   캡스톤 디자인 활동을 하면서 배운 점이 정말 많다. 팀장으로써 수행했던 일들과 팀원들과 함께 개발 진행에 있어서까지 잊을 수 없는 활동들을 경험하였고, 함께하는 사람들과 성취감을 느끼고 단합력을 끌어올릴 수 있는 프로젝트였다. 
  
   우리 팀은 이번 프로젝트 결과물을 가지고 2학기에 통합성과경진대회에 참가해보기러 했다. 프로젝트가 잘 끝나고 난 후여서 그런지, 팀 분위기가 정말 좋아져서 다들 자신감도 더불어 생겨진 것 같다. 각자 졸업을 앞두고 여러 준비를 하느라 바쁠 텐데 참여한다고 말해주었을 때, 그만큼 다른 팀원들도 이번 프로젝트에 의미가 깊었던 걸 느낄 수 있었다.
  
   처음 제대로 된 팀장을 맡아 부족했던 점도 있었을 텐데, 함께한 팀원들도 너무 잘 따라와주고 서포트를 잘해주어서 잘 마무리 된 것 같고, 고맙고, 지금 글을 쓰는 와중에도 여러 감정이 오간다.
   팀원들 정말 고생했고, 앞으로도 잊지 못할 좋은 프로젝트 활동이었다.    
 
  ![image](https://user-images.githubusercontent.com/84834776/194801072-afde25fd-16bd-407d-af41-d25c5661d3d5.png)
  
  <img width="128" alt="image" src="https://user-images.githubusercontent.com/84834776/194801107-8412c134-4291-40ab-beb1-f3281c82fd9c.png">
  
### 8. 깃허브 링크

  [코드 링크](https://github.com/hwanggiju/Capstone_Design.git)
