...
프로젝트 도중 어색함을 풀기 위해 짧은 시간이지만, 프로젝트 관한 얘기에서 벗어나 서로에 대해 알아가기 위한 시간을 가졌었다. 이후 나름 편한 분위기가 조성되었고, 프로젝트 진행하면서도
...
### 8. 깃허브 링크
  ...
  [코드](https://github.com/hwanggiju/Detect_WildAnimals.git)
